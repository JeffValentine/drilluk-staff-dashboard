...
begin
  if not exists (
    select 1 from pg_constraint where conname = 'interview_applications_age_range'
  ) then
    alter table public.interview_applications
  ...
  if not exists (
    select 1 from pg_constraint where conname = 'interview_applications_hours_range'
  ) then
    alter table public.interview_applications
  ...
  if not exists (
    select 1 from pg_constraint where conname = 'interview_applications_public_text_size'
  ) then
    alter table public.interview_applications
...
insert into public.affiliate_profiles (
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@arrondrilluk"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
    now()
  ),
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@baldyy00"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@venom31.4"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@franksabout"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'youtube',
    '{"youtube":"https://youtube.com/@gummzgaming","tiktok":"https://www.tiktok.com/@gummzgaming"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'twitch',
    '{"twitch":"https://www.twitch.tv/nsidestreamers"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@mmb_664"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@moses_fivem"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@mrwick847"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://vm.tiktok.com/ZN9d2rsLBvttD-rwkcp/"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@gameglitch23"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
  ...
  (
    ...
    'active',
    'tiktok',
    '{"tiktok":"https://www.tiktok.com/@__msngg__"}'::jsonb,
    'Preloaded from the DRILL-UK creator / affiliate socials overview.',
    '{}'::jsonb,
    '{"mode":"manual","syncNotes":"Preloaded profile. Add stat snapshots after streams or weekly reviews."}'::jsonb,
    true,
...
on conflict (slug) do update set
  ...
  handles = public.affiliate_profiles.handles || excluded.handles,
  notes = coalesce(nullif(public.affiliate_profiles.notes, ''), excluded.notes),
  goals = coalesce(public.affiliate_profiles.goals, '{}'::jsonb),
